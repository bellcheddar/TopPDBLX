...
| `ontology/synonyms.yaml` | The reagent dictionary: 517 reagents, 1,463 spellings |
...
| Reagent lexicon | 517 reagents, 1,463 names (v0.8.1) |
...
| v0.8.1: all remaining duplicate ids merged, 5 invariants now tested | **517** | **1,463** | re-parse pending |
