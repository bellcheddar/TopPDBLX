...
| `ontology/synonyms.yaml` | The reagent dictionary: 509 reagents, 1,462 spellings |
...
| Reagent lexicon | 509 reagents, 1,462 names (v0.8.2) |
...
| v0.8.2: leaked amount and method words merged onto their reagents | **509** | **1,462** | re-parse pending |
