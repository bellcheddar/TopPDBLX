...
| `ontology/synonyms.yaml` | The reagent dictionary: 485 reagents, 1,461 spellings |
...
| Reagent lexicon | 485 reagents, 1,461 names (v0.8.3) |
...
| v0.8.3: Marc's review — formula ids renamed to names, 3 wrong aliases removed | **485** | **1,461** | re-parse pending |
